...
Original file is located at
    https://colab.research.google.com/drive/10UaUrPQs2t5mKeyiXTlmxQxk_zNFM_HE
"""
...
if car_cascade.empty():
    print(f"Error loading cascade classifier from: {car_cascade_src}")
    print("Please ensure 'cars.xml' is in the correct directory or provide the full path.")
else:
    print(f"Cascade classifier loaded successfully from: {car_cascade_src}")
    cars = car_cascade.detectMultiScale(closing, 1.1, 1)

car_cascade_src = '/content/sample_data/cars.xml'
...
bus_cascade_src = '/content/sample_data/Bus_front.xml'
...
cascade_src = '/content/sample_data/cars.xml'
video_src = '/content/sample_data/Cars.mp4'
